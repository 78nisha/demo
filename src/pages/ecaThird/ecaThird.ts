...
import { EcaThirdService } from './ecaThird.service';
import {Storage} from '@ionic/Storage';

@Component({
  selector: 'page-ecathird',
  templateUrl: 'ecathird.html',
  providers: [ EcaThirdService]
})
export class EcaThirdPage {
  id;
  nepaliYear;
  ecareport =[];
  constructor(public platform: Platform, public navCtrl: NavController, public loadingController:LoadingController, public storage: Storage,private ecaService: EcaThirdService,public http: Http,public httpClient: HttpClient) {
