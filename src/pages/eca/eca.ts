...
@Component({
  selector: 'page-eca',
  templateUrl: 'eca.html',
  providers: [ EcaService]
})
export class EcaPage {
  id;
  nepaliYear;
  ecareport =[];
  constructor(public platform: Platform,public navCtrl: NavController, public loadingController:LoadingController, public storage: Storage,private ecaService: EcaService,public http: Http,public httpClient: HttpClient) {
